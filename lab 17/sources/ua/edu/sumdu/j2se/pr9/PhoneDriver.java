                ...
                case 3:
                    ...
                    if (phoneToMod == null) {
                        ...
                        if (modChoice == 1) {
                            ...
                            boolean successMod = store.update(phoneToMod, phoneToMod);
                            if(successMod) System.out.println("-> Price updated successfully!");
                            ...
                            boolean successMod = store.update(phoneToMod, phoneToMod);
                            if(successMod) System.out.println("-> Storage updated successfully!");
                            else System.out.println("-> Update error.");
                        } else {
                ...
                case 4:
                    ...
                    if (phoneToDel == null) {
                        ...
                        if (confirm.equalsIgnoreCase("y")) {
                            boolean successDel = store.delete(phoneToDel);
                            if (successDel) {
