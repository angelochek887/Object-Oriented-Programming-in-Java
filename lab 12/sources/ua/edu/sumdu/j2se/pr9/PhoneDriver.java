...
public class PhoneDriver {
    ...
    public static void main(String[] args) {
        // Перевірка аргументів для підключення до БД (Завдання 12)
        if (args.length == 0) {
    ...
    private static void creationSubMenu() {
        ...
        try {
            ...
            if (newPhone != null) {
                ...
                // Віддзеркалення об'єкта в базу даних
    ...
    private static void loadData() {
        // Оскільки ми працюємо з БД, файл input.txt більше не потрібен для завантаження
