...
public class DatabaseManager {
    ...
    public void savePhone(Phone ph, int quantity) {
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            // Обробка специфічних полів (Null, якщо тип інший)
            pstmt.setNull(8, Types.INTEGER);  // camera_mp
            pstmt.setNull(9, Types.BOOLEAN);  // has_flashlight
            pstmt.setNull(10, Types.VARCHAR); // cooling
            pstmt.setNull(11, Types.VARCHAR); // provider
